...
export class CoronavirusMapCentKmComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    const tags = [
      ...
      { property: 'og:title', content: `Carte de la zone circulation de 100 km autour du domicile pour le déconfinement` },
      // tslint:disable-next-line:max-line-length
      ...
      { name: 'twitter:title', content: `Carte de la zone de circulation de 100 km autour du domicile pour le déconfinement` },
      // tslint:disable-next-line:max-line-length
